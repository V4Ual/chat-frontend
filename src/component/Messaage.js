...
const Message = ({ profilePic, image, text, time, name, onClickDownload }) => {
    ...
    return (
        ...
        <div class="flex items-start gap-2.5 m-2 rounded">
                ...
                <div class="flex flex-col w-full max-w-[326px] leading-1.5 p-4 border-gray-200 bg-gray-100 rounded-e-xl rounded-es-xl dark:bg-gray-700">
                    ...
                    <div class="group relative my-2.5">
                        <div class="absolute w-full h-full bg-gray-900/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-lg flex items-center justify-center">
                            ...
                            <div id="download-image" role="tooltip" class="z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
                                <div class="tooltip-arrow" data-popper-arrow></div>
                            </div>
                        </div>
                        <Image src={image} width="320" height="480" class="rounded-lg" />
                    </div>
